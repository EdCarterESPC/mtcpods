...
//  XDUICommon
//
//  Created by Timothy on 08/03/2017.
//  Copyright © 2017 xDesign. All rights reserved.
//

import UIKit

public protocol TableViewInput: class {
    ...
    func configuredTableViewCell(for displayItem: Any, at indexPath: IndexPath) -> UITableViewCell
}
